...
ConstraintLayout btn_transactionmenu,btn_balance,btn_addclient,btn_calendar,btn_chat;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_transactionmenu =findViewById(R.id.transactionlayout);
        btn_balance=findViewById(R.id.balancelayout);
        btn_addclient=findViewById(R.id.addnewlayout);
        btn_calendar=findViewById(R.id.calendarlayout);
        btn_chat=findViewById(R.id.chatlayout);
